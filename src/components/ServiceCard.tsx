const services = [
  {
    ...
    description:
      "We provide expert architectural consultations to help you shape your ideas into clear, functional, and well-planned design concepts tailored to your needs.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "We create innovative, functional, and aesthetically refined architectural designs that balance modern style with everyday practicality.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  },
  {
    ...
    description:
      "We manage and oversee construction projects of all sizes, ensuring precision, quality craftsmanship, and smooth execution from start to finish.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  {
    title: "Architectural Support & Maintenance",
    description:
      "We provide ongoing support for built structures, including updates, improvements, and maintenance to ensure long-term durability and performance.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
