const services = [
  {
    ...
    description: 'We offer comprehensive architectural consultation services to help clients bring their vision to life.',
    icon: (
  ...
  },
  {
    ...
    description: 'We specialize in creating innovative, functional, and visually stunning architectural designs.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10">
  ...
  },
  {
    ...
    description: 'We offer comprehensive construction building services for projects of all sizes. With experienced professionals team.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10">
  ...
  {
    title: 'Architectural Maintenance',
    description: 'We specialize in creating innovative, functional, and visually stunning architectural designs.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-10">
    ...
    <section id="services" className="bg-black pb-20">
      ...
      <div>
        {services.map((service, index) => (
          <div key={index} className="mx-8 flex flex-col max-w-xs pt-20 first:pt-0">
